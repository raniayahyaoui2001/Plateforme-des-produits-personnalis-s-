  ...
  if ($row[3]==5)
   {
     if($x % 4 !=0)
     {
        ...
        $im = $row[2];
        echo "<span class='imgproduit'> <img src='img/galerie/personalise/$im' class='imgproduit'/> <br/> 
...
?>
 ...
 <div class="preced"><a href="shooting2.php"> Shooting</a></div>
 <div class="suiv"><a href="web2.php"> Web </a></div>
 <br/>
