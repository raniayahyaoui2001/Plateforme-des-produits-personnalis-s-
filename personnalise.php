  ...
  if ($row[3]==5)
   {
     if($x % 4 !=0)
     {
        ...
        $im = $row[2];
        echo "<span class='imgproduit'> <img src='img/galerie/personalise/$im' class='imgproduit'/> <br/> </span>";
...
?>
 ...
 <div class="preced"><a href="shooting.php"> Shooting</a></div>
 <div class="suiv"><a href="web.php"> Web </a></div>
 <br/>
