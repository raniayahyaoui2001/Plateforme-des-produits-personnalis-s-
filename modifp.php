...
";
     ...
     $id = $_REQUEST['dd'];
     // Récupérer toutes les données de produit
     $res = $produit->cnx()->query("SELECT * from produit where id_produit=$id");
     $la_produit=$res->fetch();
   echo" <div class='aj'> <form action='modifp_action.php?dd=$id' method='post'>
   <h3>Modifier un produit </h3>
   <br> <br>
   <div class='form-group'>
    <label for='nom'>Nom </label>
    <input type='text' class='form-control' id='nom'  value='$la_produit[1]' name='nom'>  
    </div>
    <div class='form-group'>
    <label for='image'>Image</label>
    <input type='file' class='form-control' id='image'  value='$la_produit[2]' name='image'>
    </div><br/>
