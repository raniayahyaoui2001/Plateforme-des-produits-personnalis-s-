...
require_once("contacts.php");
 ...
 $con = mysqli_connect('127.0.0.1:3306','root','','site') or die('Unable To connect');
 $obj = "SELECT * FROM categorie";
...
echo"
<div class='aj'>
<form action='insertp_action.php' method='post'>
<h3> Ajout d'un nouvel produit </h3>
<br> <br>
...
if(isset($_REQUEST['retour']))
{
  ...
  if($res)
  {
    echo "<center><b><span style='color:green'>Success</span></b></center>";
  }
  
  else
  {
    echo "<center><b><span style='color:red'>Erreur</span></b></center>";
  }
