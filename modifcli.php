...
";
     ...
     $id = $_REQUEST['dd'];
     // Récupérer toutes les données de client
     $res = $client->cnx()->query("SELECT * from client where id_client=$id");
     $la_client=$res->fetch();
   echo" 
   <div class='aj'> 
   <form  action='modifcli_action.php?dd=$id' method='post'>
   <h3>Modifier une catégorie </h3>
   <br/> <br/>
    <div class='form-group'>
    <label for='nom'>Nom </label>
    <input type='text' class='form-control' id='nom'  value='$la_client[1]' name='nom'>  
    </div>
    <div class='form-group'>
    <label for='image'>Image</label>
    <input type='file' class='form-control' id='image'  value='$la_client[2]' name='image'>
    </div>
    <div class='form-group'>
    <label for='nom'>Description </label>
    <textarea class='form-control' id='description'  value='$la_client[1]' name='description'> </textarea> 
    </div> <br/>
