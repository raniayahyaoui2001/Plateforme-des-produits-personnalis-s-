...
.pic img{
  ...
  .pic:hover .hoverimg{
    ...
    background-image: linear-gradient(to top, #f5f5f5, #f5f5f5, #f5f5f5, #f5f5f5, #f5f5f5);
    font-family:"Comic Sans MS";
    cursor: pointer;
  }
...
try{
    ...
    while($d=$res->fetch())
    {
        ...
        {
            $im = $d['image'];
            echo" <br/> <br/> <a href='charte.php'> <div class='pic charte'>
        ...
        {
            $im = $d['image'];
            echo" <br/> <br/> <a href='packaging.php'> <div class='pic packaging'>
        ...
        {
            $im = $d['image'];
            echo" <br/> <br/> <a href='habillage.php'> <div class='pic habillage'>
        ...
        {
            $im = $d['image'];
            echo" <br/> <br/> <a href='shooting.php'> <div class='pic shooting'>
        ...
        {
            $im = $d['image'];
            echo" <br/> <br/> <a href='personnalise.php'> <div class='pic personnalise'>
        ...
        {
            $im = $d['image'];
            echo" <br/> <br/> <a href='web.php'> <div class='pic web'>
