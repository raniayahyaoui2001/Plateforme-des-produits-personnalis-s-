      ...
      if ($row[3]==2)
       {
         if($x % 4 !=0)
         {
            ...
            $im = $row[2];
            echo "<span class='imgproduit'> <img src='img/galerie/packaging/$im' class='imgproduit'/> <br/> </span>";
...
?>
 ...
 <div class="preced"><a href="charte.php"> Charte graphique </a></div>
 <div class="suiv"><a href="habillage.php"> Habillage </a></div>
 <br/>
