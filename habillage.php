  ...
  if ($row[3]==4)
   {
     if($x % 4 !=0)
     {
        ...
        $im = $row[2];
        echo "<span class='imgproduit'> <img src='img/galerie/habillage/$im' class='imgproduit'/> <br/> </span>";
...
?>
 ...
 <div class="preced"><a href="packaging.php"> Packaging </a></div>
 <div class="suiv"><a href="shooting.php"> Shooting </a></div>
 <br/>
