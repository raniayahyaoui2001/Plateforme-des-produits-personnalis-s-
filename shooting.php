  ...
  if ($row[3]==3)
   {
     if($x % 4 !=0)
     {
        ...
        $im = $row[2];
        echo "<span class='imgproduit'> <img src='img/galerie/shooting/$im' class='imgproduit'/> <br/></span>";
...
?>
 ...
 <div class="preced"><a href="habillage.php"> Habillage </a></div>
 <div class="suiv"><a href="personnalise.php"> Personnalisé </a></div>
 <br/>
